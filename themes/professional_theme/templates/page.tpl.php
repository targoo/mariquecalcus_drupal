...
<div id="wrapper">
  ...
  <div id="footer">
    ...
    <?php if (!theme_get_setting('copyright_override')){?>
      <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print theme_get_setting('copyright_holder') ?></p>
    <?php } else {?>
       <?php echo theme_get_setting('copyright_override');?>
    <?php } ?>
    <?php } ?>
